...
<body>
    <main class="main_wrapper body__overlay overflow__hidden">
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="breadcrumb__title">
                            <ul>
                                <li>
                                    <a href="#!">Product > Dhoop Cones > Jar Cones</a>
                                </li>
                            </ul>
                        </div>
                        <div class="filter-bttn mt-3">
                            <form action="" class="filter-btns">
                                ...
                                <div class="input-form">
                                    <select name="" id="">
                                        <option value="Price" selected disabled>Category</option>
                                        <option value="100">100</option>
                                        <option value="200">200</option>
                                        <option value="300">300</option>
                                    </select>
        ...
        <div class="category sp_bottom_50 sp_top_40">
            <div class="container">
                <div class="row">
