...
<div class="header__topbar header__topbar__3" style="background-image: url(images/top-header.png);
 background-size: cover; background-repeat: no-repeat; background-position: right;">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="text-center">
                    <p class="topp">QUICK BUY! Get up to 25% off on All Stones</p>
                </div>
            </div>
        </div>
    </div>
...
<header>
    <div class="headerarea header__sticky headerarea__middle headerarea__middle__6 desktop__menu__wrapper">
        <div class="container ">
            <div class="row common__row align-items-center">

                <div class="col-md-3 main_menu_wrap">
                ...
                <div class="col-md-6">
                    <div class="home__6__middle">
                        <div class="header__search__6">
                            <div class="search-bx">
                                <i class="fas fa-map-marker-alt"></i>
                                <p>Deliver to <br> 110094</p>
                            </div>
                ...
                <div class="col-md-3">
                    <div class="headerarea__right">
                        <ul class="headerarea__right__nav d-flex">
                            <li>
                                <a href="#" class="headermiddle__bar">
                            ...
                            <li>
                                <div class="setting__wrap">
                                    <a class="setting__wrap__active" href="#">
                                    ...
                                    <a href="#!" class="u-text"> SIGN IN / SIGN UP</a>
                                </div>
                            </li>
                        </ul>
                    </div>
    ...
    <!-- header__bottom__start -->
    <div class="header__bottom desktop__menu__wrapper">
        <div class="container">
            <div class="row common__row position-relative">
                <div class="col-xl-12 main_menu_wrap">
